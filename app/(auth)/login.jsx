    ...
    <View style={styles.backside}>
      <View style={styles.teste}>
          <Image
            ...
            resizeMode="contain"
          />
        <Text style={[styles.formContainer, {color: "white", fontSize: 20, letterSpacing: 4, fontWeight: "bold"}]}>
          Bem-vindo de volta!
        </Text>
        <FormField
          title="E-mail"
        ...
        />
        <View style={{justifyContent: "center", flexDirection: "row", gap: 2}}/*"justify-center pt-5 flex-row gap-2"*/>
          <Text style={{color: "white", paddingBottom: 20}}>Não tem uma conta?</Text>
          <Link
            href={"/cadastro"}
